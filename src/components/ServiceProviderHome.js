...
function ServiceProviderHome() {
  ...
  //     localStorage.getItem("role") !== "2"
  //   ) {
  //     // Redirect to login if role is not 2
  //     // window.location.href = "/login";
  //   }
  // }, []);
      ...
      <header className="masthead text-center">
        <div className="masthead-content">
          <div className="container">
            <h1 className="masthead-heading mb-0">Homely Services Booking</h1>
            ...
            <a
              href="/booking"
              className="btn btn-secondary btn-xl rounded-pill mt-5 ms-3"
            >
              View Bookings to confirm
            </a>
          </div>
        </div>
            ...
            <div className="col-lg-6 order-lg-2">
              <div className="p-5">
                <img
                  ...
                  src="https://images.unsplash.com/photo-1510563800743-aed236490d08?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2700&q=80"
                  alt=""
                />
              </div>
            </div>
            <div className="col-lg-6 order-lg-1">
              <div className="p-5">
                <h2 className="display-4">
                  Book a servicesfor user near you
                </h2>
                <p>
                  "Discover convenience at your doorstep with our exceptional
                  home services. From skilled technicians to expert artisans,
                  we've gathered a network of service providers ready to cater
                  to your every need. Whether it's a plumbing fix, a garden
                  transformation, or a fresh coat of paint, you can now
                  effortlessly book a service provider near you. Experience
                  quality, reliability, and a touch of magic in every service,
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="p-5">
                <img
                  className="img-fluid rounded-circle"
                  src="https://images.unsplash.com/photo-1471560090527-d1af5e4e6eb6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2700&q=80"
                  alt=""
                />
              </div>
            </div>
            <div className="col-lg-6">
              <div className="p-5">
                ...
                <p>
                  Embrace the luxury of time for yourself and your loved ones
                  by entrusting your home services to us. With our dedicated
                  professionals taking care of your every need, you can reclaim
                  precious moments to relax, unwind, and indulge in the things
                  that truly matter. Say goodbye to the stress of chores and
                  repairs we've got you covered. It's not just a service; it's
                  a gateway to a life with more time to relax, rejuvenate, and
