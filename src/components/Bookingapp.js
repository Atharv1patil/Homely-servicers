...
function Bookingapp() {
  ...
  const [Services, SetMobile] = useState("");
  const [ServiceProvider, setEmail] = useState("");
  const [problemDescription, setPassword] = useState("");
  const [DateTime, setAddress] = useState("");
  const Status = "Active";
