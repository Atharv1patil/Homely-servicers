...
const WindowCleaner = ({ specialization }) => {
    ...
    const fetchServiceProviders = async () => {
        try {
            const response = await axios.get(`http://13.48.25.89:8080/api/serviceprovider/bySpecialization?specialization=WindowCleaner`);
